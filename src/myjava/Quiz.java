...
public class Quiz extends JFrame implements ActionListener{
	...
	Quiz(String name)
	{
		...
		//Image
		ImageIcon i1 = new ImageIcon(Login.class.getResource("/images/quiz.jpg"));
        ...
        next.setBounds(1100,500,150,30);
        ...
        lifeline.setBounds(1100,580,150,30);
        ...
        submit.setBounds(1100,660,150,30);
	...
	public void paint(Graphics g)//apne aap call hota hai
	{
		super.paint(g);
		
		String time = "Time Left - "+timer+" seconds";//15s
		...
		else if(timer<0)
		{
			...
			if(count==9)
			{
				if(groupoptions.getSelection()==null)
				 ...
				 {
					  useranswers[count][0]=groupoptions.getSelection().getActionCommand();//value nikalne ke liye getActionCommand()
				 }
				for (int i = 0; i < 10; i++) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(e.getSource()==submit)
		{
			...
			{
				if (this.useranswers[i][0] != null && answers[i][1] != null && this.useranswers[i][0].equals(answers[i][1])) {
				    score += 10;
				} else {
				    score += 0;
				}
